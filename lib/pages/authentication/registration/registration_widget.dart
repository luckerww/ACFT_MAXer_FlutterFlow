                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'REGISTRATION_PAGE_Icon_ek7i60pb_ON_TAP');
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'REGISTRATION_PAGE_SIGN_UP_BTN_ON_TAP');
                                          var _shouldSetState = false;
                                          logFirebaseEvent(
                                              'Button_backend_call');
                                          _model.apiResultkc5 =
                                              await NewUserAlertCall.call(
                                            email: _model
                                          ...
                                          if ((_model.apiResultkc5?.succeeded ??
                                              true)) {
                                            context.goNamedAuth(
                                                'main_screen', context.mounted);
