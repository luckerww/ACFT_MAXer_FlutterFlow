...
class _GalleryPageWidgetState extends State<GalleryPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'gallery_page'});
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'GALLERY_PAGE_PAGE_Icon_ar28iwz9_ON_TAP');
                      ...
                      Expanded(
                        child: StreamBuilder<List<SavedStoryRecord>>(
                          stream: querySavedStoryRecord(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<SavedStoryRecord>
                                listViewSavedStoryRecordList = snapshot.data!;

                            return ListView.builder(
                              padding: EdgeInsets.zero,
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
                              itemCount: listViewSavedStoryRecordList.length,
                              itemBuilder: (context, listViewIndex) {
                                final listViewSavedStoryRecord =
                                    listViewSavedStoryRecordList[listViewIndex];
                                return Padding(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            listViewSavedStoryRecord.storyText,
