        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => OnboardingSlidesWidget(),
            ),
            FFRoute(
              name: 'registration',
              path: 'registration',
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'main_screen')
                  : MainScreenWidget(),
            ),
            FFRoute(
              name: 'create_story',
            ...
            FFRoute(
              name: 'generated_story_page',
              path: 'generatedStoryPage',
              builder: (context, params) => GeneratedStoryPageWidget(
            ...
            FFRoute(
              ...
              path: 'galleryPage',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'gallery_page')
                  : GalleryPageWidget(),
            ),
            FFRoute(
              name: 'profile',
